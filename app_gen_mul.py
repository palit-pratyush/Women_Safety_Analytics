...
ssd_prototxt = cv2.data.haarcascades + 'deploy.prototxt.txt'  # Replace with actual path to the prototxt file
ssd_weights = cv2.data.haarcascades + 'res10_300x300_ssd_iter_140000.caffemodel'  # Replace with actual path to the caffemodel file
